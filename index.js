$(document).ready(function () {
    ...
    var tableauDeBase = JSON.parse(localStorage.getItem('tableauDeBase'));
    if(tableauDeBase == null)
    {
        tableauDeBase = [];
    }
    else
    ...
    $("#addElement").click(function () {
        ...
        console.log(tableauDeBase);
        $(".tableauDeBase").html(tableauDeBase.join(" "));
        clearForm();
        console.log(tableauDeBase);
        var myJsonString = JSON.stringify(tableauDeBase);
        localStorage.setItem('tableauDeBase', myJsonString);
        console.log(localStorage.getItem('tableauDeBase'));
    });

    $("#deleteElement").click(function () {
        console.log(tableauDeBase.pop());
        $(".tableauDeBase").html(tableauDeBase.join(" "));
        var myJsonString = JSON.stringify(tableauDeBase);
        localStorage.setItem('tableauDeBase', myJsonString);
    });
    ...
    $("#nouveauTirage").click(function () {
        tableauDeBase = [];
        var myJsonString = JSON.stringify(tableauDeBase);
        localStorage.setItem('tableauDeBase', myJsonString);
        $("#lancer").show();
        tableauDeBase = localStorage.getItem('tableauDeBase');
        tableauDeSortie = [];
        $("#resultat").html("");
        $("#elementsPicked").html("");
    })
